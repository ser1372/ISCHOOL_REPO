<style>
    #oopss {
        background: linear-gradient(-45deg, #814AF1, #814AF1);
        position: fixed;
        left: 0px;
        top: 0;
        width: 100%;
    ...
    #oopss #error-text .back {
        ...
        padding: .7em 2em;
        border-radius: 500px;
        box-shadow: 0 20px 70px 4px rgba(0, 0, 0, 0.1), inset 7px 33px 0 0px #F4EFFF;
        font-weight: 900;
...
<div id='oopss'>
    <div id='error-text'>
        ...
        <span>500 PAGE</span>
        <p class="p-a">
            . Oops... An error occurred, please try again later!</p>
        <p class="p-b">
